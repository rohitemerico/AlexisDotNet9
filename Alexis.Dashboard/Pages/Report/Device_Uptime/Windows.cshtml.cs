...
public class WindowsModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public List<WindowsDeviceSLAViewModel> DeviceUptime { get; set; }
    ...
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_DeviceUptimeWindows);
    }
    ...
    private void BindDataByDateRange(DateTime? startDate, DateTime? endDate)
    {
        ...
        else
        {
            ...
            DeviceUptime = Common.DataHelper.ConvertDataTableToList<WindowsDeviceSLAViewModel>(data);
        }
    }
}
