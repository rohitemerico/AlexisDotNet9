...
namespace Alexis.Dashboard.Pages.Report.Device_Uptime;
...
public class AndroidModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public string ExportFileName { get => $"{FilterType}_Uptime_{DateTime.Now.ToString("yyyyMMdd")}"; }
    ...
    public List<AndroidDeviceSLAViewModel> DeviceUptime { get; set; }
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_DeviceUptimeAndroid);
    }
    ...
    private void BindDataByDateRange(DateTime? minDate, DateTime? maxDate)
    {
        ...
        else
        {
            ...
            data = _reportController.GetDeviceUptimeAndroid(StartDate, EndDate);
            DeviceUptime = Common.DataHelper.ConvertDataTableToList<AndroidDeviceSLAViewModel>(data);
        }
    }
}
