...
public class iOSModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public List<iOSDeviceSLAViewModel> DeviceUptime { get; set; }
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_DeviceUptimeiOS);
    }
    ...
    private void BindDataByDateRange(DateTime? startDate, DateTime? endDate)
    {
        ...
        {
            data = _reportController.GetDeviceUptimeiOS(StartDate, EndDate);
            DeviceUptime = Common.DataHelper.ConvertDataTableToList<iOSDeviceSLAViewModel>(data);
        }
    }
}
