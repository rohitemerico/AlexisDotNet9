...
public class FinancingProductModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public List<MSFDepositProductViewModel> FinancingProducts { get; set; }
    ...
    private void BindDataByDateRange(DateTime? minDate, DateTime? maxDate)
    {
        ...
        else
        {
            ...
            FinancingProducts = Common.DataHelper.ConvertDataTableToList<MSFDepositProductViewModel>(data);
        }
    }
}
