...
namespace Alexis.Dashboard.Pages.Report.Device_SLA;
...
public class AndroidModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public string ExportFileName { get => $"{FilterType}_SLA_{DateTime.Now.ToString("yyyyMMdd")}"; }
    ...
    public List<AndroidDeviceSLAViewModel> DeviceSLA { get; set; }
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_DeviceSLAAndroid);
    }
    ...
    private void BindDataByDateRange(DateTime? startDate, DateTime? endDate)
    {
        ...
        else
        {
            ...
            DeviceSLA = Common.DataHelper.ConvertDataTableToList<AndroidDeviceSLAViewModel>(data);
        }
    }
}