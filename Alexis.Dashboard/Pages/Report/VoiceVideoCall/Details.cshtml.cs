...
public class DetailsModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public string ExportFileName { get => $"Voice_Video_Call_Transactions_Details_{DateTime.Now.ToString("yyyyMMdd")}"; }
    ...
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_VoiceVideoCallDetails);
    }
    ...
    private void BindDataByDateRange(DateTime? minDate, DateTime? maxDate)
    {
        ...
        {
            data = _reportController.VoiceVideoCallTransactionsDetails(StartDate, EndDate);
