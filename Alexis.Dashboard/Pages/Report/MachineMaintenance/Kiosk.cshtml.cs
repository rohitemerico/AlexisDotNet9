...
public class KioskModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    public List<KioskMaintenanceViewModel> KioskMaintenanceList { get; set; }
    public string ExportFileName { get => $"MachineMaintenance_Kiosk_{DateTime.Now.ToString("yyyyMMdd")}"; }
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_MachineMaintenanceKiosk);
    }
