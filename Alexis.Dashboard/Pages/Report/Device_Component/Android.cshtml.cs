...
public class AndroidModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public List<AndroidDeviceComponentViewModel> DeviceComponents { get; set; }
    ...
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_DeviceComponentAndroid);
    }
    ...
    private void BindDataByDateRange(DateTime? startDate, DateTime? endDate)
    {
        ...
        {
            data = reportController.Get_Android_DeviceComponent(StartDate, EndDate);
            DeviceComponents = Common.DataHelper.ConvertDataTableToList<AndroidDeviceComponentViewModel>(data);
        }
    }
}
