...
public class WindowsModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public List<WindowsDeviceComponentViewModel> DeviceComponents { get; set; }
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_DeviceComponentWindows);
    }
    ...
    private void BindDataByDateRange(DateTime? minDate, DateTime? maxDate)
    {
        ...
        {
            data = reportController.Get_Windows_DeviceComponent(StartDate, EndDate);
            DeviceComponents = Common.DataHelper.ConvertDataTableToList<WindowsDeviceComponentViewModel>(data);
        }
    }
}
