...
public class SummaryModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public string ExportFileName { get => $"DocumentAPI_Summary_{DateTime.Now.ToString("yyyyMMdd")}"; }
    ...
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_DocumentAPISummary);
    }
    ...
    private void BindDataByDateRange(DateTime? startDate, DateTime? endDate)
    {
        ...
        {
            data = _reportController.GetDocumentAPISummary(StartDate, EndDate);
