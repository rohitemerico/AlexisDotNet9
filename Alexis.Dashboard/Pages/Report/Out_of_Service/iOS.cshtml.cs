...
public class iOSModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public string ExportFileName { get => $"{FilterType}_Downtime_{DateTime.Now.ToString("yyyyMMdd")}"; }
    ...
    public List<iOSDeviceSLAViewModel> DeviceDowntime { get; set; }
    ...
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_OutofServiceiOS);
    }
    ...
    private void BindDataByDateRange(DateTime? startDate, DateTime? endDate)
    {
        ...
        else
        {
            ...
            DeviceDowntime = Common.DataHelper.ConvertDataTableToList<iOSDeviceSLAViewModel>(data);
        }
    }
}
