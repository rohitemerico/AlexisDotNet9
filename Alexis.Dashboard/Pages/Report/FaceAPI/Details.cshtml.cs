...
public class DetailsModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    ...
    public string ExportFileName { get => $"FaceAPI_Details_{DateTime.Now.ToString("yyyyMMdd")}"; }
    ...
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_FaceAPIDetails);
    }
    ...
    private void BindDataByDateRange(DateTime? startDate, DateTime? endDate)
    {
        ...
        {
            data = _reportController.GetFaceAPIDetails(StartDate, EndDate);
