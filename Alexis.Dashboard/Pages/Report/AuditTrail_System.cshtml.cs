...
public class AuditTrail_SystemModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    public string ExportFileName { get => $"AuditTrail_System_{DateTime.Now.ToString("yyyyMMdd")}"; }

    const string FilterType = "system_";
    ...
    public override void OnPageHandlerExecuting(PageHandlerExecutingContext context)
    {
        ...
        checkAuthorization(ModuleLogAction.View_AuditTrailSystem);
    }
