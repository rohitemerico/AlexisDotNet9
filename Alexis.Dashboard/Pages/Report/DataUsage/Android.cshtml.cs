...
{
    public List<AndroidDeviceDataUsageViewModel> DeviceDataUsage { get; set; }
    ...
    {
        DataTable DataTable1 = AndroidMDMController.GetDeviceDataUsage();
        DeviceDataUsage = Common.DataHelper.ConvertDataTableToList<AndroidDeviceDataUsageViewModel>(DataTable1);
    }
}