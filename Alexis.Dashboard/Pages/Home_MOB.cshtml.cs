...
public class Home_MOBModel(IHttpContextAccessor httpContextAccessor) : BasePageModel(httpContextAccessor)
{
    protected MOBController _mob = new MOBController();
    ...
    {
        Json_AllSummary = _mob.GetAllTransSummaryByDays(int.Parse(DatePeriod));
        Json_TransType = _mob.GetTransTypeSummaryByDays(int.Parse(DatePeriod));
    }
